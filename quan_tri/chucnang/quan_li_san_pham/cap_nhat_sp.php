...
<?php
$masp = $_GET['masp'];
$sql = "select * from san_pham join cau_hinh on san_pham.masp= cau_hinh.masp where san_pham.masp=?";
$stmt = $db->prepare($sql);
...
<div class="addproduct">
    <form method="post" action="?menu=exec_cap_nhat_sp" enctype="multipart/form-data">
        <table>
            <tr>
                ...
                <td>
                    <select name="loaisp" id="loaisp"  required >
                        ...
                        foreach ($resultSet as $row1) {
                            ?>
                            <option value="<?php echo $row1['id'] ?>" <?php if ($row['loaisp'] == $row1['id']) {
                                    echo "selected";
                                } else {
                                    echo "";
                                }
            ...
            <tr>
                ...
                <td>
                    <select name="quay_phim" id="quay_phim">
                        <option value="có" <?php if ($row['quay_phim'] == "có") {
    echo "selected";
} else {
    echo "";
} ?> >Có</option>
                        <option value="không" <?php if ($row['quay_phim'] == "không") {
    echo "selected";
} else {
    echo "";
} ?> >Không</option>
                ...
                <td>
                    <select name="video_call" id="video_call">
                        <option value="có" <?php if ($row['video_call'] == "có") {
    echo "selected";
} else {
    echo "";
} ?> >Có</option>
                        <option value="không" <?php if ($row['video_call'] == "không") {
    echo "selected";
} else {
    echo "";
} ?> >Không</option>
                ...
                <td>
                    <select name="den_flash" id="den_flash">
                        <option value="có" <?php if ($row['den_flash'] == "có") {
    echo "selected";
} else {
    echo "";
} ?> >Có</option>
                        <option value="không" <?php if ($row['den_flash'] == "không") {
    echo "selected";
} else {
    echo "";
} ?> >Không</option>
            ...
            <tr>
                ...
                <td><select name="single3g4g" id="single3g_4g">
                        <option value="3G" <?php if ($row['single3g4g'] == "3G") {
    echo "selected";
} else {
    echo "";
} ?> >3G</option>
                        <option value="3G/4G" <?php if ($row['single3g4g'] == "3G/4G") {
    echo "selected";
} else {
    echo "";
} ?> >3G/4G</option>
            ...
            <tr>
                <td>
                    <select name="wifi" id="wifi">
                        <option value="có" <?php if ($row['wifi'] == "có") {
    echo "selected";
} else {
    echo "";
} ?> >Có</option>
                        <option value="không" <?php if ($row['wifi'] == "không") {
    echo "selected";
} else {
    echo "";
} ?> >Không</option>
                ...
                <td>
                    <select name="gps" id="gps">
                        <option value="có" <?php if ($row['gps'] == "có") {
    echo "selected";
} else {
    echo "";
} ?> >Có</option>
                        <option value="không" <?php if ($row['gps'] == "không") {
    echo "selected";
} else {
    echo "";
} ?> >Không</option>
                ...
                <td>
                    <select name="bluetooth" id="bluetooth">
                        <option value="có" <?php if ($row['bluetooth'] == "có") {
    echo "selected";
} else {
    echo "";
} ?> >Có</option>
                        <option value="không" <?php if ($row['bluetooth'] == "không") {
    echo "selected";
} else {
    echo "";
} ?> >Không</option>
                ...
                <td>
                    <select name="gprs_edge" id="gprs_edge">
                        <option value="có" <?php if ($row['gprs_edge'] == "có") {
    echo "selected";
} else {
    echo "";
} ?> >Có</option>
                        <option value="không" <?php if ($row['gprs_edge'] == "không") {
    echo "selected";
} else {
    echo "";
} ?> >Không</option>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <select name="noi_bat" id="noi_bat" name="noi_bat">
                        <option value="có" <?php if ($row['noi_bat'] == "có") {
    echo "selected";
} else {
    echo "";
} ?> > Có</option>
                        <option value="không" <?php if ($row['noi_bat'] == "không") {
    echo "selected";
} else {
    echo "";
} ?> >Không</option>
            ...
            <form method="post" action="?menu=exec_cap_nhat_sp">
