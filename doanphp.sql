...
-- Dumping data for table doanphp.binh_luan: ~5 rows (approximately)
...
-- Dumping data for table doanphp.hoa_don: ~5 rows (approximately)
/*!40000 ALTER TABLE `hoa_don` DISABLE KEYS */;
INSERT INTO `hoa_don` (`ma_hoadon`, `id_kh`, `ten_kh`, `email`, `sdt`, `dia_chi`, `sp_mua`, `ngay_mua`, `xu_ly`, `tong_tien`) VALUES
	(19, 'nhvong', 'Nguyễn Hữu Vọng', 'nguyenhuuvong.nhv@gmail.com', '0389251012', 'Quảng Nam', '4,1,30990000|10,1,24990000|', '2020-12-16 14:08:04', 'Chưa xử lý', 55980000),
	(20, 'nhvong', 'Nguyễn Hữu Vọng', 'nguyenhuuvong.nhv@gmail.com', '0389251012', 'Quảng Nam', '4,1,30990000|6,1,10990000|15,1,19990000|', '2021-01-16 20:22:52', 'Hoàn thành', 61970000),
	(21, 'nhvong', 'Nguyễn Hữu Vọng', 'nguyenhuuvong.nhv@gmail.com', '0389251012', 'Quảng Nam', '11,1,50000000|', '2021-01-16 20:23:00', 'Chưa xử lý', 50000000),
	(22, 'nhvong', 'Nguyễn Hữu Vọng', 'nguyenhuuvong.nhv@gmail.com', '0389251012', 'Quảng Nam', '10,1,24990000|13,1,9490000|28,1,5990000|', '2021-01-16 20:23:15', 'Đã tiếp nhận', 40470000),
	(23, 'nhminh', 'Ngô Hoàng Minh', 'hoangminh@gmail.com', '0919873677', '200 Văn Tiến Dũng, Hòa Xuân, Cẩm Lệ, Đà Nẵng', '9,3,7210000|', '2021-01-16 20:25:00', 'Chưa xử lý', 21630000),
	(24, 'leuyen', 'Lê Uyên', 'leuyen@gmail.com', '0978978999', 'Quảng Nam', '18,1,42990000|', '2021-01-16 20:27:17', 'Hoàn thành', 42990000),
	(25, 'nhvong', 'Nguyễn Hữu Vọng', 'nguyenhuuvong.nhv@gmail.com', '0389251012', 'Quảng Nam', '7,1,2790000|', '2021-01-18 12:13:01', 'Hoàn thành', 2790000);
...
CREATE TABLE IF NOT EXISTS `nguoidung` (
  ...
  PRIMARY KEY (`IdND`),
  KEY `FK_nguoidung_phan_quyen` (`ma_quyen`),
  CONSTRAINT `FK_nguoidung_phan_quyen` FOREIGN KEY (`ma_quyen`) REFERENCES `phan_quyen` (`ma_quyen`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table doanphp.nguoidung: ~4 rows (approximately)
...
-- Dumping structure for table doanphp.phan_quyen
...
-- Dumping data for table doanphp.phan_quyen: ~2 rows (approximately)
...
-- Dumping data for table doanphp.slideshow: ~6 rows (approximately)
